...
begin
    ...
    #     "Currency": "EUR",
    #         "PaymentMethod": {
    #         "RedirectURL": "https://www.paypal.com/webscr&cmd=_express-checkout&token=EC-45222578DU642061G",
	...
	# next: redirect shopper to PayPal to confirm payment
	redirectUrl = contents['PaymentDetails']['PaymentMethod']['RedirectURL']
	# [do redirect]
